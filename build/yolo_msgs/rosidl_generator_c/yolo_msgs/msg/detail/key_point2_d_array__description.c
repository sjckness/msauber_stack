...
static char yolo_msgs__msg__KeyPoint2DArray__FIELD_NAME__data[] = "data";

static rosidl_runtime_c__type_description__Field yolo_msgs__msg__KeyPoint2DArray__FIELDS[] = {
  {
    {yolo_msgs__msg__KeyPoint2DArray__FIELD_NAME__data, 4, 4},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription yolo_msgs__msg__KeyPoint2DArray__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {yolo_msgs__msg__KeyPoint2D__TYPE_NAME, 24, 24},
    {NULL, 0, 0},
  },
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {yolo_msgs__msg__KeyPoint2DArray__FIELDS, 1, 1},
    },
    {yolo_msgs__msg__KeyPoint2DArray__REFERENCED_TYPE_DESCRIPTIONS, 2, 2},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[0].fields = yolo_msgs__msg__KeyPoint2D__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[1].fields = yolo_msgs__msg__Point2D__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
yolo_msgs__msg__KeyPoint2DArray__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *yolo_msgs__msg__KeyPoint2DArray__get_individual_type_description_source(NULL),
    sources[1] = *yolo_msgs__msg__KeyPoint2D__get_individual_type_description_source(NULL);
    sources[2] = *yolo_msgs__msg__Point2D__get_individual_type_description_source(NULL);
    constructed = true;
  }
