...
static const _SetClasses_Event_type_support_symbol_names_t _SetClasses_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yolo_msgs, srv, SetClasses_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, yolo_msgs, srv, SetClasses_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, yolo_msgs, srv, SetClasses_Event)() {
  return &::yolo_msgs::srv::rosidl_typesupport_c::SetClasses_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t SetClasses_service_type_support_handle = {
  ...
  &SetClasses_Request_message_type_support_handle,
  &SetClasses_Response_message_type_support_handle,
  &SetClasses_Event_message_type_support_handle,
