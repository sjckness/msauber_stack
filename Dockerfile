...
RUN apt-get update \
    ...
    && rosdep install \
      ...
      --skip-keys "ament_python gz-sim8 controller_manager joint_state_publisher_gui foxglove_bridge nav2_map_server nav2_planner nav2_lifecycle_manager nav2_msgs" \
      -r -y
